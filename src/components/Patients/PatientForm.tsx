...
import { Barcode, Save, X, Globe, Building, Loader2 } from 'lucide-react';
import {
  Dialog,
  DialogContent,
  DialogDescription,
...
interface PatientFormProps {
  ...
  onSubmitSuccess?: (patient: PatientData) => void;
  oid?: string | null;
  cin?: string | null;
...
const PatientForm: React.FC<PatientFormProps> = ({
  ...
  const [clinics, setClinics] = useState<any[]>([]); // Use any[] to match the dynamic response
