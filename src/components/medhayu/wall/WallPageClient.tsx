...
import { MessageSquare, ThumbsUp, ThumbsDown, Repeat, BookOpen, Quote as QuoteIcon, ChevronDown, TrendingUp, Rss, Plus, Leaf, FileText, Microscope, Heart, Send, Save, Bookmark, HelpCircle, Check, Star, Users, Stethoscope, Building, Sparkles, Loader2, MoreVertical, Edit, Trash2 } from 'lucide-react';
...
import { TextSelectionMenu } from '../Article renderer/text-selection-menu';
import { UserCitationDialog } from '../Article renderer/user-citation-dialog';
import { CommentFormDialog } from '../Article renderer/comment-form-dialog';
...
const postTypeToReactionsMap: Record<Post['postType'], (keyof typeof reactionConfig)[]> = {
    thought: ['like', 'dislike', 'discuss', 'share', 'save'],
    dravyaguna: ['like', 'dislike', 'discuss', 'save'],
    shloka: ['like', 'dislike', 'discuss', 'save'],
    'case-study': ['like', 'dislike', 'discuss', 'save'],
    dinacharya: ['like', 'dislike', 'discuss', 'share', 'save'],
    tips: ['like', 'dislike', 'share', 'save'],
    formulation: ['like', 'dislike', 'discuss', 'save'],
    event: ['like', 'dislike', 'share', 'save'],
    poll: ['like', 'dislike', 'discuss', 'save'],
    question: ['like', 'dislike', 'discuss', 'save'],
    book: ['like', 'dislike', 'discuss', 'share', 'save'],
    'book-article': ['like', 'dislike', 'discuss', 'share', 'save'],
    article: ['like', 'dislike', 'discuss', 'share', 'save'],
    whitepaper: ['like', 'dislike', 'discuss', 'share', 'save'],
    abstract: ['like', 'dislike', 'discuss', 'share', 'save'],
};
